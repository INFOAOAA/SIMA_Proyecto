...
La contaminación atmosférica constituye uno de los principales problemas ambientales relacionados con la salud pública, especialmente en zonas urbanas donde convergen actividades industriales, tránsito vehicular, crecimiento poblacional y condiciones meteorológicas que pueden favorecer la acumulación de contaminantes. La Organización Mundial de la Salud reconoce que la exposición a la contaminación del aire está asociada con diversos efectos adversos sobre la salud, incluyendo enfermedades cardiovasculares y respiratorias, y considera como contaminantes de especial importancia al material particulado PM10 y PM2.5, el ozono (O3), el dióxido de nitrógeno (NO2), el dióxido de azufre (SO2) y el monóxido de carbono (CO) \cite{who2021}. Por lo anterior, la medición continua de la calidad del aire es necesaria no solamente para conocer las condiciones ambientales de una región, sino también para generar información que permita prevenir riesgos y apoyar la toma de decisiones.

El Área Metropolitana de Monterrey presenta condiciones particularmente relevantes para el estudio de la contaminación atmosférica. La presencia de zonas industriales, una alta actividad urbana y vehicular, así como la topografía característica de la región, pueden influir en la generación, transporte, dispersión y acumulación de los contaminantes. Además, las condiciones meteorológicas no permanecen constantes: variables como la temperatura, humedad relativa, precipitación, radiación solar, presión atmosférica, velocidad y dirección del viento pueden modificar la manera en que los contaminantes se distribuyen en el espacio y en el tiempo. En consecuencia, analizar únicamente la concentración de un contaminante sin considerar el entorno en el que fue registrada puede proporcionar una visión incompleta del fenómeno.

Estudios realizados previamente en el Área Metropolitana de Monterrey muestran la importancia de considerar estas diferencias espaciales y temporales. Mancilla et al. \cite{mancilla2019} encontraron diferencias en la concentración y composición del material particulado entre distintas zonas del área metropolitana, observando que las partículas gruesas presentaban variaciones espaciales asociadas con fuentes primarias locales, mientras que las partículas finas mostraban un comportamiento relativamente más homogéneo. Por otra parte, Aguirre-López et al. \cite{aguirre2022}, al analizar concentraciones de PM10 entre 2010 y 2018, identificaron una periodicidad anual y diferencias geográficas entre estaciones, con mayores concentraciones promedio durante los periodos de otoño e invierno. Estos resultados muestran que el análisis de la calidad del aire requiere considerar simultáneamente diferentes variables y ubicaciones.

En Nuevo León, el Sistema Integral de Monitoreo Ambiental (SIMA) constituye una de las principales fuentes de información para observar el comportamiento de la calidad del aire en el Área Metropolitana de Monterrey. A través de su red de estaciones, el sistema genera mediciones de distintos contaminantes criterio y parámetros meteorológicos. El portal de SIMA permite consultar información relacionada con el Índice AIRE Y SALUD, concentraciones de contaminantes, reportes de calidad del aire, normatividad ambiental y métodos de medición \cite{aire_nl}. De esta manera, el monitoreo proporciona información que puede utilizarse tanto para informar a la población como para estudiar el comportamiento de los contaminantes y apoyar estrategias de gestión ambiental.

La documentación proporcionada para este proyecto muestra que las estaciones de SIMA se encuentran distribuidas en diferentes zonas del área metropolitana y presentan diferencias de ubicación y elevación. Para 2025 se documentan 15 estaciones correspondientes a zonas como Centro, Norte, Sur, Noreste, Noroeste, Sureste y Suroeste \cite{ubicacion_sima2025}. Esta distribución permite observar un mismo fenómeno ambiental bajo condiciones geográficas diferentes y hace posible analizar tanto variaciones entre estaciones como posibles relaciones con las condiciones meteorológicas registradas en cada una de ellas.

Entre las variables disponibles se encuentran contaminantes como PM10, PM2.5, O3, NO, NO2, NOx, SO2 y CO, además de parámetros meteorológicos como temperatura, humedad relativa, radiación solar, precipitación, presión atmosférica, velocidad del viento y dirección del viento \cite{rangos_sima}. La presencia simultánea de múltiples contaminantes y variables meteorológicas convierte al conjunto de datos en un problema naturalmente multivariado, ya que los cambios observados en la calidad del aire pueden estar relacionados con varias condiciones que actúan al mismo tiempo.

La interpretación de estas mediciones requiere además distinguir entre los límites establecidos para proteger la salud y los rangos técnicos de funcionamiento de los instrumentos. En México, las Normas Oficiales Mexicanas para la calidad del aire establecen concentraciones y periodos de exposición específicos para contaminantes como CO, SO2, O3, NO2, PM10 y PM2.5 \cite{aire_nl}. Estos límites no deben confundirse con los rangos de operación de los sensores. Los rangos de operación indican los valores dentro de los cuales se espera que un instrumento pueda realizar una medición válida, mientras que las normas de calidad del aire establecen referencias relacionadas con la exposición de la población.

La medición de la calidad del aire también presenta dificultades desde el punto de vista de los datos. Fallas de comunicación, calibraciones, valores fuera del rango esperado, registros faltantes y observaciones que deben invalidarse pueden afectar la información registrada. La documentación de SIMA incluye rangos de operación específicos y criterios para identificar determinadas lecturas que no deben utilizarse \cite{rangos_sima}. Por ello, antes de realizar cualquier análisis estadístico es necesario revisar la calidad de los registros, cuantificar los valores faltantes, identificar posibles observaciones erróneas y establecer criterios adecuados de limpieza y preparación.

Esta necesidad de preparación también se observa en investigaciones anteriores realizadas con información de SIMA. Por ejemplo, Pozo-Luyo et al. \cite{pozoluyo2023} utilizaron un conjunto de datos multivariado de calidad del aire del Área Metropolitana de Monterrey para desarrollar modelos de predicción de PM2.5 y requirieron procedimientos de imputación de datos faltantes, tratamiento de valores extremos y escalamiento de las variables antes del modelado. Esto ejemplifica la importancia de realizar primero una etapa de comprensión y depuración de los datos antes de intentar extraer conclusiones de ellos.

Como complemento al monitoreo ambiental, la Dirección General de Gestión de la Calidad del Aire y Registro de Emisiones y Transferencia de Contaminantes de la SEMARNAT administra el Registro de Emisiones y Transferencia de Contaminantes (RETC). Este registro difunde información sobre las sustancias emitidas o transferidas por establecimientos sujetos a reporte y tiene entre sus objetivos proporcionar información útil para la sociedad, la investigación y el desarrollo de políticas orientadas a reducir la contaminación \cite{semarnat_retc}. Mientras que SIMA permite observar las concentraciones presentes en el ambiente, el RETC proporciona información complementaria relacionada con emisiones provenientes de diferentes actividades productivas.

A partir de este contexto el presente proyecto seguirá la metodología CRISP-DM, comenzando con la comprensión del problema y posteriormente con la comprensión y preparación de los datos proporcionados por SIMA. El análisis buscará aprovechar la naturaleza multivariada de la información para estudiar las relaciones existentes entre las condiciones atmosféricas y la calidad del aire en el Área Metropolitana de Monterrey. La pregunta específica de investigación, las variables prioritarias y el periodo definitivo de análisis se establecerán a partir de la revisión bibliográfica y de la evaluación inicial de la calidad y disponibilidad de los datos.
...
Primeramente se consolido una base de datos global, incluyendo desde el año 2020 hasta el 2025, ciertamente había años en los que había mayor proporción de datos faltantes, sin embargo, se tomó la decisión de trabajar con todos los años a pesar de las diferencias que pueden presentar en comportamientos. Por ejemplo, los años 2020 y 2021 fueron los más afectados por cuestiones de la pandemia, y por ende, una reducción en la movilidad de carros, trabajo de industrias y actividad en general. Se depuró la base de datos eliminando anomalías registradas por los sensores (temperaturas de -57 °C y vientos sobre 158 km/h), acotando los valores a límites realistas para el contexto regiomontano (-5 °C a 45 °C y máximo 80 km/h). Las correcciones se aplicaron mediante arrastre del último valor válido (forward fill) por estación @tbl-coherencia. Dicho esto, para los datos faltantes, se encontró que promedio había un 10% de información faltante para cada variable. Ante esta situación, se hizo una imputación de datos por medio de un método de interpolación lineal. Para este paso es muy importante recordar que los comportamientos entre estaciones son muy diferentes entre si, por eso la interpolación también se tuvo que hacer de manera independiente. Los datos faltantes se trataron de acuerdo a la NOM.
El siguiente paso fue de estandarización, este proceso es necesario porque las variables de la base de datos estan en unidades completamente distintas. Si no lo estandarizaramos, al momento de hacer el análisis factorial, se distorsionaría el peso de las variables solo por tener números más grandes en sus escalas originales. 
