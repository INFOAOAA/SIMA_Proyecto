...
La Zona Metropolitana de Monterrey (ZMM), consolidada como uno de los centros industriales y urbanos más dinámicos de América Latina, enfrenta un problema estructural de contaminación atmosférica enfocado en el material particulado menor a 10 micrómetros ($PM_{10}$). La topografía de la ZMM, caracterizada por un valle semiárido rodeado por barreras naturales de gran elevación como la Sierra Madre Oriental, el Cerro de las Mitras y el Cerro de la Silla, limita la ventilación natural y favorece la acumulación de contaminantes. Este fenómeno se agudiza durante los meses de invierno debido al incremento en la frecuencia de inversiones térmicas subsidiaras (\cite{gonzalez2011temporal}).

A la condición geofísica se suma un parque vehicular en constante expansión y una densa actividad industrial (siderúrgica, cementera, química y de generación eléctrica). Las concentraciones diarias de $PM_{10}$ superan sistemáticamente los límites máximos permisibles de la norma NOM-025-SSA1, representando un riesgo directo para la salud pública al asociarse con un incremento en admisiones hospitalarias por enfermedades respiratorias y cardiovasculares (\cite{ceronbreton2021short}).

El Sistema de Monitoreo Ambiental (SIMA) opera una red automatizada de 15 estaciones continuas. Sin embargo, los esquemas tradicionales de gestión ambiental suelen operar de forma reactiva, emitiendo alertas cuando las concentraciones ya han rebasado los umbrales normativos. La transición hacia una gestión preventiva requiere la implementación de modelos predictivos capaces de anticipar la dinámica del contaminante con varias horas de antelación.

La justificación de este trabajo radica en estructurar una metodología analítica transparente, reproducible e interpretable. En lugar de utilizar modelos de caja negra, la integración de la Distancia de Mahalanobis para la selección de sitios de monitoreo, el Análisis Factorial Exploratorio (AFE) para la resolución de la multicolinealidad y la modelación autorregresiva SARIMAX permite al SIMA contar con un sistema de alerta temprana fundamentado estadísticamente para respaldar la toma de decisiones operativas.
